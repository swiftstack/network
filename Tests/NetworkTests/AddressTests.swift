...
class AddressTests: TestCase {
    ...
    func testIPv4() throws {
        ...
        expect(address.description == "127.0.0.1:5000")
    }
    ...
    func testIPv6() throws {
        ...
        expect(address.description == "::1:5001")
    }
